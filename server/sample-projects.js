module.exports = [
  {
    ...
    title: "AssetFlow",
    description:
      "Enterprise asset management system with RBAC, async APIs, JWT authentication, and real-time WebSocket notifications. React/Vite frontend.",
  ...
  },
  {
    ...
    description:
      "Complete gym website with membership management, admin dashboard, and Stripe payment integration.",
